...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" href="<?= base_url('lib') ?>/assets/images/logos.jpg" type="image/x-icon">
    <!-- Google font-->
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="login-card card-block auth-body mr-auto ml-auto">
                        <form class="md-float-material" action="<?= base_url('auth/getData'); ?>" method="post">
                            <div class="text-center">
                                <img src="<?= base_url('lib/assets/images/logos.jpg'); ?>" alt="logo.png" style="width: 70px; height: 70px;">
                            </div>
                            <div class="auth-box">
...
<![endif]-->
    ...
    <script type="text/javascript" src="<?= base_url('lib/assets/js/modernizr/css-scrollbars.js') ?>"></script>
    <script type="text/javascript" src="<?= base_url('lib/assets/js/common-pages.js') ?>"></script>
</body>
